...
enyo.kind({
    ...
    rendered: function () {
         ...
         */_cat.core.action(this, {"pkgName":"enyo-test.Carousel.enyoNext"},this, pagesList);
         ...
         */_cat.core.action(this, {"pkgName":"enyo-test.Carousel.letsGo"},this, btn);
    ...
    slideHandler: function (inSender, inEvent) {
        ...
        */console.log("Single Scrap example");
